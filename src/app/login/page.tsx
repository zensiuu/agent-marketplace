      ...
      <div className="flex-1 flex items-center justify-center px-4 py-12">
        <div className="w-full max-w-sm">
          ...
          <div className="card p-6">
            ...
            <p className="text-sm text-[#8a8f98] mb-6">Sign in to your account</p>

            {error && (
              <div className={`mb-4 p-3 rounded-lg text-sm ${error.includes('Check') ? 'bg-[rgba(16,185,129,0.1)] text-[#10b981] border border-[rgba(16,185,129,0.2)]' : 'bg-[rgba(239,68,68,0.1)] text-red-500 border border-[rgba(239,68,68,0.2)]'}`}>
                {error}
              </div>
            )}
            ...
            <div className="mt-6 text-center">
              <p className="text-sm text-[#8a8f98]">
                ...
                <Link href="/signup" className="text-[#7170ff] hover:text-[#828fff]">
                  Sign up
                </Link>
              </p>
            </div>
